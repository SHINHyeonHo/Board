...
<body>
    <div id="container">
        <div id="step1" style="display: none"> <!--좌석 선택-->
            <div id="step1Grid">
                <div id="top">
                    <div id="changeArea">
                        <span>관람일 변경</span>
                ...
                <div id="seatInfo">
                    ...
                    <button id="reset" onclick="reset()"><img src="resetIcon.png" width="10px">  좌석 다시 선택</button>
        ...
        <div id="step4" style="display: block"> <!--결제 방법-->
        ...
        <div id="bookingInfo" style="display: block">
            <div id="bkgShowInfo">
                <table>
                    <tr>
                        <td rowspan="2">
...
<script src="seatSelScript1.js"></script>
</html>